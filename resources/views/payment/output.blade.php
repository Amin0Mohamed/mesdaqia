...
<div class="card" id="cars_d">
    <div class="card-body">
        <div class="container">
            <div class="row" >
                <div class="col-md-12">
                    <h2 class="text-capitalize text-center">this is a notifications</h2>
                    <div style="background-color:#f00;width: 15%;height: 2px;margin: 15px auto"></div>
                    <h4 class="text-center text-blue" style="color:#09c">{{$show}} </h4>
                    <img class=" d-block" style="margin: 30px auto" src="img/done1.gif" width="27%" height="30%" alt="fgg" >
                    <a href="{{ url('/add_product') }}"  class="btn btn-outline-info text-capitalize m-auto  d-block w-25 ">go to profile</a>
                </div>
            </div>
        </div>
