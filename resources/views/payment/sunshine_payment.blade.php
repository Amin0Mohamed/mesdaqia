            ...
            <div class="row" >
                ...
                <div class="col-md-6">
                    ...
                    <div class="forms">
                        ...
                        <!-- ====================================== -->
                        <form action="{{url('/sunshine_savedatacustomer')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="input-group mb-3">
                                <input type="number" name="price" class="form-control" placeholder="Amount" value="{{$price}}" required>
                            </div>
                            <input type="submit" class="btn btn-outline-primary btn-block btn_sub" value="continue">
