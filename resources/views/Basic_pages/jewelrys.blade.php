                ...
                <div class="row use-box">
                    <div id="mySidenav2" class="sidenav">
                            ...
                            <div class="card card-block">
                                <form method="get" action="/search_jewelry">
                                    ...
                                    <div class="input-group " >
                                        ...
                                        <input type="number" name="price" id="price_veh"  placeholder="حدد السعر" required>
                                    </div>
                                    <!-- ======= -->
                                    <h6 class="text-center">حالـة المنتج</h6>
                                    <div class="input-group">
                                        <select name="status" id="status_veh" required>
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="type" id="type_veh" placeholder="type" required>
                                    </div>
                                    <!-- =================== -->
                                    <h6 class="text-center">المواد</h6>
                                    <div class="input-group">
                                        <input type="text" name="material" placeholder="المواد" required>
                                    </div>
                                    <!-- ======= -->
                                    <h6 class="text-center">الوزن</h6>
                                    <div class="input-group">
                                        <input type="text" name="weight" placeholder="الوزن" required>
                                    </div>
                        ...
                        <div class="" id="search_2_veh">
                            <select onchange="display_search_veh()" name="serch_for" id="serch_for_veh" required>
                            ...
                            <div class="card card-block" id="dis_card_veh">
                                <div class="input-group " id="dis_input_veh">
                                    <form method="get" action="/search_jewelry">
                                        <input type="text" name="price"  placeholder="حدد السعر" required>
                                        <input type="submit" value="إبحـث" class="btn btn-outline-primary btn-block btn_s" required>
                                    </form>
                                </div>
                                <div class="input-group " id="dis_input2_veh">
                                    <form method="get" action="/search_jewelry">
                                        <select name="status" id="stat_veh" required>
                                            <option value="new product">new product</option>
                                            <option value="used product">used product</option>
                                        </select>
                                        <input type="submit" value="إبحـث" class="btn btn-outline-primary btn-block btn_s" required>
                                ...
                                <div class="input-group " id="dis_input3_veh">
                                    <form method="get" action="/search_jewelry">
                                        <input type="text" name="type" placeholder="النوع" value="" id="type_veh" required>
                                        <input type="submit" value="إبحـث" class="btn btn-outline-primary btn-block btn_s" required>
                                    </form>
                                </div>
                                <div class="input-group " id="dis_input4_veh">
                                    <form method="get" action="/search_jewelry">
                                        <input type="text" name="material" placeholder="المواد" value="" required>
                                        <input type="submit" value="إبحـث" class="btn btn-outline-primary btn-block btn_s" required>
                                    </form>
                                </div>
                                <div class="input-group " id="dis_input5_veh">
                                    <form method="get" action="/search_jewelry">
                                        <input type="text" name="weight" placeholder="الوزن" value="" id="year_veh"  required/>
                                        <input type="submit" value="إبحـث" class="btn btn-outline-primary btn-block btn_s" required>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-3 cl">
                            <div class="card">
                                <div class="product">
                                    ...
                                    <div class="r">
                                        <p class="heart">{{$jewelry->viewers}}<i class="fa fa-heart" ></i></p>
                                        <label for="">@lang('site.viewers')</label>
                                    </div>

                                    <div class="r">
                                        <p class="heart"> {{$jewelry->type}}</p>
                                        <label for="">@lang('site.type')</label>
                                    </div>
                                    <div class="r">
                                        <p class="heart"> {{ $jewelry->price }}</p>
                                        <label for="">@lang('site.price')</label>
                                    </div>
                                    <div class="r">
                                        <p class="heart"> {{ $jewelry->weight }}</p>
