...
class ProductData extends Controller
{
    protected function carsproduct($id){
        ...
        $viewer = ++$cars->viewers;
        $cars->save();
        return redirect()->route('cardetail',compact('id','ownerID','image','type','color','model','new','Guarant','location','price'));
    ...
    protected function vichleproduct($id){
        ...
        $vichle->save();
        return redirect()->route('vichledetail',compact('id','ownerID','image','type','color','model','new','Guarant','location','price'));
    ...
    protected function propertyproduct($id){
        ...
        $property->save();
        return redirect()->route('propertydetail',compact('id','ownerID','image','SizeInMeter','type','floors','rooms','new','Guarant','location','price'));
    ...
    protected function highvalueproduct($id){
        ...
        $highvalue->save();
        return redirect()->route('highvaluedetail',compact('id','ownerID','image','type','floors','name','Guarant','price','new'));
    ...
    protected function jewelryproduct($id){
        ...
        $jewelry->save();
        return redirect()->route('jewlerydetail',compact('id','ownerID','image','type','material','weight','new','Guarant','location','price'));
